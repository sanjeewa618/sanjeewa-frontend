...
_c = CheckoutPage;
function CheckoutForm({ cartItems, subtotal, tax, shipping, total }) {
    _s();
    ...
    const handleContinueToPayment = ()=>{
        // Validate form
        if (!shippingInfo.firstName || !shippingInfo.lastName || !shippingInfo.email || !shippingInfo.phone || !shippingInfo.address || !shippingInfo.city || !shippingInfo.state || !shippingInfo.zipCode) {
...
_s(CheckoutForm, "XrIUqrUt6Npf7mBtTJmaPMKd8Iw=", false, function() {
    return [
...
//# sourceMappingURL=_9ee627b2._.js.map